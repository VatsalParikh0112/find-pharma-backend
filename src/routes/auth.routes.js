...
router.post(
  ...
  [body('email').isEmail().withMessage('Please enter a valid email').normalizeEmail(), phoneRule],
  sendRegistrationOtp,
);
...
router.put(
  ...
  [
    ...
    body('currentOtp')
      .matches(/^\d{6}$/)
      .withMessage('Current email OTP must be 6 digits'),
    body('newOtp')
      .matches(/^\d{6}$/)
      .withMessage('New email OTP must be 6 digits'),
  ],
  changeEmail,
);
...
router.put(
  ...
  [
    ...
    body('currentOtp')
      .optional({ checkFalsy: true })
      .matches(/^\d{6}$/)
      .withMessage('Current phone OTP must be 6 digits'),
    body('newOtp')
      .matches(/^\d{6}$/)
