...
const pharmacies = [
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-83.9430, 35.9940] },
    openingHours: 'Mon–Fri: 8:00 AM – 9:00 PM, Sat–Sun: 9:00 AM – 6:00 PM',
  },
  {
    name: 'Walgreens',
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-83.9381, 36.0290] },
    openingHours: 'Mon–Fri: 9:00 AM – 9:00 PM, Sat–Sun: 10:00 AM – 6:00 PM',
  },
  {
  ...
  // ── West Knox / Bearden / Kingston Pike (37919) ─────────────────────────
  {
    ...
    location: { type: 'Point', coordinates: [-84.0690, 35.9479] },
    openingHours: 'Mon–Fri: 9:00 AM – 8:00 PM, Sat: 9:00 AM – 6:00 PM',
  },
  {
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-84.1490, 35.9135] },
    openingHours: 'Mon–Fri: 9:00 AM – 9:00 PM, Sat–Sun: 10:00 AM – 6:00 PM',
  },
  {
    name: 'Publix Pharmacy',
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-84.1210, 35.8968] },
  ...
  },
  {
    name: 'Rite Aid Pharmacy',
    phone: '+18659152145',
    address: { street: '8801 Strawberry Plains Pike', city: 'Knoxville', state: 'TN', pincode: '37871' },
  ...
  },
  {
    ...
    phone: '+18659152146',
    address: { street: '4515 Strawberry Plains Pike', city: 'Knoxville', state: 'TN', pincode: '37871' },
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-83.9270, 36.0450] },
    openingHours: 'Mon–Fri: 9:00 AM – 7:00 PM, Sat: 9:00 AM – 7:00 PM',
  },
  ...
  // ── Maryville / Alcoa (37701, 37801, 37804) ─────────────────────────────
  {
    name: 'CVS Pharmacy',
    phone: '+18659172201',
    address: { street: '235 W Lamar Alexander Pkwy', city: 'Maryville', state: 'TN', pincode: '37801' },
  ...
  },
  {
    name: 'Publix Pharmacy',
    phone: '+18659172203',
    address: { street: '318 E Lamar Alexander Pkwy', city: 'Maryville', state: 'TN', pincode: '37804' },
  ...
  },
  {
    name: 'Kroger Pharmacy',
    phone: '+18659172204',
    address: { street: '1105 W Lamar Alexander Pkwy', city: 'Maryville', state: 'TN', pincode: '37801' },
  ...
  },
  {
    name: 'Walmart Pharmacy',
    phone: '+18659172205',
    address: { street: '215 E Lamar Alexander Pkwy', city: 'Maryville', state: 'TN', pincode: '37804' },
  ...
  },
  {
    name: 'Walgreens',
    phone: '+18654812302',
    address: { street: '1055 Oak Ridge Turnpike', city: 'Oak Ridge', state: 'TN', pincode: '37830' },
  ...
  },
  {
    name: 'Kroger Pharmacy',
    phone: '+18654812303',
    address: { street: '1245 Oak Ridge Turnpike', city: 'Oak Ridge', state: 'TN', pincode: '37830' },
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-84.2680, 36.0052] },
    openingHours: 'Mon–Fri: 9:00 AM – 7:00 PM, Sat: 9:00 AM – 7:00 PM',
  },
  ...
  // ── Clinton / Anderson County (37716) ───────────────────────────────────
  {
    name: 'CVS Pharmacy',
    phone: '+18654572501',
    address: { street: '307 N Charles Seivers Blvd', city: 'Clinton', state: 'TN', pincode: '37716' },
  ...
  },
  {
    name: 'Walgreens',
    phone: '+18654572502',
    address: { street: '415 N Charles Seivers Blvd', city: 'Clinton', state: 'TN', pincode: '37716' },
  ...
  },
  {
    name: 'Kroger Pharmacy',
    phone: '+18654572503',
    address: { street: '901 N Charles Seivers Blvd', city: 'Clinton', state: 'TN', pincode: '37716' },
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-84.1310, 36.1019] },
    openingHours: 'Mon–Sat: 9:00 AM – 6:00 PM',
  },
  {
  ...
  },
  {
    ...
    location: { type: 'Point', coordinates: [-83.5580, 35.8629] },
    openingHours: 'Mon–Sun: 24 Hours',
  },
  {
    name: 'Kroger Pharmacy',
    phone: '+18654532603',
    address: { street: '536 Winfield Dunn Pkwy', city: 'Sevierville', state: 'TN', pincode: '37876' },
  ...
  // ── Morristown / Hamblen County (37814) ─────────────────────────────────
  {
    name: 'CVS Pharmacy',
    phone: '+18239872701',
    address: { street: '2901 W Andrew Johnson Hwy', city: 'Morristown', state: 'TN', pincode: '37814' },
  ...
  },
  {
    name: 'Walgreens',
    phone: '+18239872702',
    address: { street: '2560 W Andrew Johnson Hwy', city: 'Morristown', state: 'TN', pincode: '37814' },
  ...
  },
  {
    name: 'Kroger Pharmacy',
    phone: '+18239872703',
    address: { street: '3100 W Andrew Johnson Hwy', city: 'Morristown', state: 'TN', pincode: '37814' },
  ...
  },
  {
    name: 'Walmart Pharmacy',
    phone: '+18239872704',
    address: { street: '3465 W Andrew Johnson Hwy', city: 'Morristown', state: 'TN', pincode: '37814' },
  ...
  // ── Jefferson City (37760) ───────────────────────────────────────────────
  {
    name: 'CVS Pharmacy',
    phone: '+18654752801',
    address: { street: '1501 W Old Hwy 11E', city: 'Jefferson City', state: 'TN', pincode: '37760' },
